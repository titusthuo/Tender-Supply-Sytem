  ...
  <div v-if="isVisible || isSlideIn || isSlideOut" 
    ...
    <div class="relative w-full max-w-md transform transition-all duration-500 ease-out"
      ...
      <div class="bg-white rounded-lg shadow-xl p-8 mx-4">
        <h2 class="text-2xl font-bold text-gray-800 mb-1">Register as a Supplier</h2>
        <p class="text-gray-600 mb-6">Bid on tenders and offer your services</p>
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="mb-4">
            ...
            >
            <p v-if="errors.servicesOffered" class="mt-1 text-sm text-red-600">{{ errors.servicesOffered }}</p>
          </div>
          ...
          <div class="mb-4">
            ...
            >
            <p v-if="errors.businessRegistrationNumber" class="mt-1 text-sm text-red-600">{{ errors.businessRegistrationNumber }}</p>
          </div>
          ...
          <div class="mb-4">
            ...
            >
            <p v-if="errors.yearsInBusiness" class="mt-1 text-sm text-red-600">{{ errors.yearsInBusiness }}</p>
          </div>
