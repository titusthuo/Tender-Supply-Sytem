  ...
  >
    <div class="h-full flex flex-col">
      ...
      <div class="p-6 border-b flex justify-between items-center bg-blue-600 text-white">
        ...
        <button 
          @click="$emit('close')" 
          class="text-white hover:text-blue-200 transition-colors duration-200 rounded-full p-2 hover:bg-blue-700"
        >
      ...
      <form @submit.prevent="submitSupplierRegistration" class="p-6 overflow-y-auto flex-grow space-y-6">
        <div class="grid grid-cols-1 gap-6">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Services/Products Offered</label>
            <input 
