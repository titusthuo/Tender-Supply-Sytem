...
<template>
  <div class="fixed inset-y-0 right-0 w-full md:w-96 bg-white shadow-lg transform transition-transform duration-300 z-50 flex flex-col">
    <!-- Blue accent bar at the top -->
    <div class="w-2 h-full bg-blue-600 absolute left-0 top-0"></div>
    ...
    <div class="flex-1 p-8 overflow-y-auto">
      ...
      <div class="mt-6 text-center">
        ...
        <button @click="handleSignUp" class="ml-1 text-sm text-blue-600 hover:underline">
          Sign Up
        </button>
      </div>
    </div>
